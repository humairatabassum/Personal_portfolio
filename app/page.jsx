      ...
      <div className='flex flex-col lg:flex-row items-center justify-between lg:pt-8 lg:pb-24'>
        ...
        <div className="text-center lg:text-left order-2 lg:order-none">
          ...
          <h1 className='h1 mb-6'>Hello I'm<br />
            <span className="text-purple-500">Lorem ipsum </span>
          </h1>
          ...
          <div className='flex flex-col items-center lg:flex-row lg:items-baseline justify-center gap-8'>
            ...
            <div className='mb-8 xl:mb-0'>
              <Social containerStyles='flex gap-6' iconStayles='w-9 h-9 border border-purple-500 rounded-full
              flex justify-center items-center text-purple-500 text-bas hover:bg-purple-500 hover:text-primary hover:transition-all duration-500'/>
            </div>
